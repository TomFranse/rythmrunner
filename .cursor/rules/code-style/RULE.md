...
**Reference:** See `.cursor/skills/optimize2/SKILL.md` for detailed refactoring workflow and examples.
...
- `.cursor/skills/optimize2/SKILL.md` - Detailed complexity reduction / optimization workflow
